            ...
            <div class="carousel-item active">
                ...
                <div class="container">
                    <div class="carousel-caption text-start">
                        <h1>عنواننا الأمثل .</h1>
                        <p class="opacity-75">أكبر وأفضل المتاجر في الشرق الأوسط . تشكيلة واسعة من المنتجات متوفرة لدينا.</p>
                        <p><a class="btn btn-lg btn-primary" href="#">سجل الأن</a></p>
                    </div>
                </div>
            </div>
